...
const byte nokia5110Flex::GLYPHS[][CHARWIDTH] PROGMEM =
{
    ...
    ,{0x10, 0x10, 0x10, 0x10, 0x10, 0x10} // D8 horizontal line segment
    ,{0x00, 0x00, 0xF0, 0x10, 0x10, 0x10} // D9 top left corner segment
    ,{0x10, 0x10, 0xF0, 0x10, 0x10, 0x10} // DA horizontal line segment with downwards extension
    ,{0x10, 0x10, 0xF0, 0x00, 0x00, 0x00} // DB top right corner segment
    ,{0x00, 0x00, 0xFF, 0x10, 0x10, 0x10} // DC vertical line segment with right extension
    ,{0x10, 0x10, 0xFF, 0x10, 0x10, 0x10} // DD four-way intersecting segment
    ,{0x10, 0x10, 0xFF, 0x00, 0x00, 0x00} // DE vertical line segment with left extension
    ,{0x00, 0x00, 0x1F, 0x10, 0x10, 0x10} // DF bottom left corner segment
    ,{0x10, 0x10, 0x1F, 0x10, 0x10, 0x10} // E0 horizontal line segment with upwards extension
    ,{0x10, 0x10, 0x1F, 0x00, 0x00, 0x00} // E1 bottom right corner segment
    ...
    ,{0x10, 0x38, 0x7C, 0x00, 0x10, 0x10} // F1 horizontal scrollbar left arrow
    ,{0x10, 0x10, 0x00, 0x7C, 0x38, 0x10} // F2 horizontal scrollbar right arrow
    ,{0x7C, 0x7C, 0x10, 0x10, 0x10, 0x10} // F3 horizontal scrollbar indicator, left position
    ,{0x10, 0x10, 0x7C, 0x7C, 0x10, 0x10} // F4 horizontal scrollbar indicator, mid position
    ,{0x10, 0x10, 0x10, 0x10, 0x7C, 0x7C} // F5 horizontal scrollbar indicator, right position
    ,{0x3C, 0x24, 0x24, 0x3C, 0x00, 0x00} // F6 checkbox, not selected
    ,{0x3C, 0x3C, 0x3C, 0x3C, 0x00, 0x00} // F7 checkbox, selected
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // F8 for application-specific use
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // F9 for application-specific use
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // FA for application-specific use
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // FB for application-specific use
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // FC for application-specific use
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // FD for application-specific use
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // FE for application-specific use
    //,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // FF for application-specific use
};
